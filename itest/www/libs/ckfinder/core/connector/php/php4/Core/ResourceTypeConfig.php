...
class CKFinder_Connector_Core_ResourceTypeConfig
{
     ...
     * @return array[]string
     */
    function getDeniedMIMETypes()
    {
        return $this->_deniedMIMETypes;
    }
	...
	/**
     * Check MIME Type, return true if file ContentType is valid.
     * Return false if ContentType is on denied list.
     * If allowed extensions are defined, return false if extension isn't on allowed list.
     *
     * @access public
     * @param string $extension extension
    ...
    function CheckMIMEType($mimeType)
    {
		...
		if (sizeof($this->_deniedMIMETypes))
		{
			if (in_array($mimeType, $this->_deniedMIMETypes)) {
                return false;
            }
		}

		if (sizeof($this->_allowedMIMETypes))
		{
			return in_array($mimeType, $this->_allowedMIMETypes);
		}
		else
		{
			return true;
