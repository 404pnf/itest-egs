...
*/
$baseUrl = '/itest/www/libs/ckfinder/userfiles/';
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => '7z,aiff,asf,avi,bmp,csv,doc,docx,gif,gz,gzip,jpeg,jpg,mid,mov,mp3,mp4,mpc,mpeg,mpg,ods,odt,pdf,png,ppt,pptx,qt,ram,rar,rm,rmvb,rtf,swf,tar,tgz,tif,tiff,txt,wav,wma,wmv,xls,xlsx,zip',
		'deniedExtensions' => '',
		'allowedMIMETypes' => 'application/x-7z-compressed,audio/x-aiff,video/x-ms-asf,video/x-msvideo,application/x-MS-bmp,text/csv,application/msword,application/vnd.openxmlformats-officedocument.wordprocessingml.document,image/gif,application/x-gzip,application/x-gzip-compressed,image/jpeg,audio/midi,video/quicktime,audio/x-mpeg,video/mp4,application/vnd.mpohun.certificate,video/mpeg,application/vnd.oasis.opendocument.spreadsheet,application/vnd.oasis.opendocument.text,application/pdf,image/png,application/vnd.ms-powerpoint,application/vnd.openxmlformats-officedocument.presentationml.presentation,video/quicktime,audio/x-pn-realaudio,application/x-rar-compressed,application/rtf,application/x-shockwave-flash,application/x-tar,image/tiff,text/plain,audio/x-wav,audio/x-ms-wma,audio/x-ms-wmv,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/x-zip-compressed',
		'deniedMIMETypes' => '');
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'avi,asf,mov,mp4,mpeg,qt,rm,rmvb,swf',
		'deniedExtensions' => '',
		'allowedMIMETypes' => 'video/x-msvideo,video/x-ms-asf,video/quicktime,video/mp4,video/mpeg,audio/x-pn-realaudio,application/x-shockwave-flash',
	'deniedMIMETypes' => '');
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => 0,
		'allowedExtensions' => 'mp3,mid,ram,wav,wma,wmv',
		'deniedExtensions' => '',
		'allowedMIMETypes' => 'audio/x-mpeg,audio/midi,audio/x-pn-realaudio,audio/x-wav,audio/x-ms-wma,audio/x-ms-wmv',
		'deniedMIMETypes' => '');		
...
$config['ResourceType'][] = Array(
		...
		'maxSize' => "16M",
		'allowedExtensions' => 'bmp,gif,ico,jpeg,jpg,png,tif,tiff',
		'deniedExtensions' => '',
		'allowedMIMETypes' => 'application/x-MS-bmp,image/gif,application/octet-stream,image/jpeg,image/png,image/tiff,text/plain,audio/x-wav,audio/x-ms-wma,audio/x-ms-wmv,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet,application/x-zip-compressed',
		'deniedMIMETypes' => '');
...
$config['ResourceType'][] = Array(
		...
		'deniedExtensions' => '',
		'allowedMIMETypes' => 'application/x-shockwave-flash',
		'deniedMIMETypes' => '');
