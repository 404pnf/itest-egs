...
//// 2007.3.11 changed by tato for jQchart . line 90.
...
$.fn.gradient = function(options) {
	...
	return this.each(function() {
		...
		if ( $this.css('position') == 'static' )
			...
			// 2007.3.11 changed by tato for jQchart 
			var method=($.browser.msie)?"append":"html"
			$this[method]('<div style="display:' + $this.css("display") + '; position: relative; z-index: 2;">' + this.innerHTML + '</div>')
			.prepend(html.join(''));
	});
};
